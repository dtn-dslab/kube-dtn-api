...
type ControllerExternalClient interface {
	...
	ApplyLinksBatchInNs(ctx context.Context, in *ApplyLinksBatchInNsQuery, opts ...grpc.CallOption) (*BoolResponse, error)
	ListLinks(ctx context.Context, in *ListLinksQuery, opts ...grpc.CallOption) (*LinksBatchResponse, error)
	DeleteLinks(ctx context.Context, in *DeleteLinksQuery, opts ...grpc.CallOption) (*BoolResponse, error)
}
...
func (c *controllerExternalClient) ApplyLinksBatchInNs(ctx context.Context, in *ApplyLinksBatchInNsQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/pb.ControllerExternal/ApplyLinksBatchInNs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controllerExternalClient) DeleteLinks(ctx context.Context, in *DeleteLinksQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/pb.ControllerExternal/DeleteLinks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControllerExternalServer interface {
	...
	ApplyLinksBatchInNs(context.Context, *ApplyLinksBatchInNsQuery) (*BoolResponse, error)
	ListLinks(context.Context, *ListLinksQuery) (*LinksBatchResponse, error)
	DeleteLinks(context.Context, *DeleteLinksQuery) (*BoolResponse, error)
...
func (UnimplementedControllerExternalServer) ApplyLinksBatchInNs(context.Context, *ApplyLinksBatchInNsQuery) (*BoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ApplyLinksBatchInNs not implemented")
}
...
func (UnimplementedControllerExternalServer) DeleteLinks(context.Context, *DeleteLinksQuery) (*BoolResponse, error) {
...
func _ControllerExternal_ApplyLinksBatchInNs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyLinksBatchInNsQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerExternalServer).ApplyLinksBatchInNs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ControllerExternal/ApplyLinksBatchInNs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerExternalServer).ApplyLinksBatchInNs(ctx, req.(*ApplyLinksBatchInNsQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ControllerExternal_DeleteLinks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteLinksQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerExternalServer).DeleteLinks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ControllerExternal/DeleteLinks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerExternalServer).DeleteLinks(ctx, req.(*DeleteLinksQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ControllerExternal_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ApplyLinksBatchInNs",
			Handler:    _ControllerExternal_ApplyLinksBatchInNs_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _ControllerExternal_DeleteLinks_Handler,
		},
	},
